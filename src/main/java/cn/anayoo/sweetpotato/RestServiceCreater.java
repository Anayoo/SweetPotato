...
public class RestServiceCreater {
    ...
    private void createGetter() throws CannotCompileException, IOException {
        ...
        JavassistUtil.addAnnotation(getterServiceFile, new String[] {"javax.ws.rs.Path", "org.springframework.stereotype.Component"}, new String[][]{{"value"}, {"value"}}, new MemberValue[][] {{new StringMemberValue("/", getterServiceConst)}, {new StringMemberValue("", getterServiceConst)}});
    ...
    private void createPoster() throws CannotCompileException, IOException {
        ...
        JavassistUtil.addAnnotation(posterServiceFile, new String[] {"javax.ws.rs.Path", "org.springframework.stereotype.Component"}, new String[][]{{"value"}, {"value"}}, new MemberValue[][] {{new StringMemberValue("/", posterServiceConst)}, {new StringMemberValue("", posterServiceConst)}});
    ...
    private void createPutter() throws CannotCompileException, IOException {
        ...
        JavassistUtil.addAnnotation(putterServiceFile, new String[] {"javax.ws.rs.Path", "org.springframework.stereotype.Component"}, new String[][]{{"value"}, {"value"}}, new MemberValue[][] {{new StringMemberValue("/", putterServiceConst)}, {new StringMemberValue("", putterServiceConst)}});
    ...
    private void createDeleter() throws CannotCompileException, IOException {
        ...
        JavassistUtil.addAnnotation(deleterServiceFile, new String[] {"javax.ws.rs.Path", "org.springframework.stereotype.Component"}, new String[][]{{"value"}, {"value"}}, new MemberValue[][] {{new StringMemberValue("/", deleterServiceConst)}, {new StringMemberValue("", deleterServiceConst)}});
